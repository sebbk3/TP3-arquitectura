...
module FETCH#(
    ...
    (
        ...
        input                       i_pc_enable,            // Habilita el PC
        input                       i_pc_reset,             // Reinicia el PC
        input                       i_read_enable,          // Habilita la lectura de la memoria de instrucciones
        input                       i_instru_mem_enable,    // Habilita la memoria de instrucciones
        input                       i_write_enable,         // Habilita la escritura de la memoria de instrucciones
        input  [NB_MEM_WIDTH-1:0]   i_write_data,           // Instruccion a escribir en la memoria 
        input  [NB_IMEM_DEPTH-1:0]  i_write_addr,           // Ubicacion de la memoria donde se escribira la instruccion 
