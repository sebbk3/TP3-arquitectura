...
`define CONTINUE           10'b0000001000
`define STEP_BY_STEP       10'b0000010000
`define DISPLAY_PC         10'b0000100000
`define READ_MEM           10'b0001000000
`define DISPLAY_MEM        10'b0010000000
`define READ_REG           10'b0100000000
`define DISPLAY_REG        10'b1000000000
...
`define CMD_STEP            8'd4 // Send step