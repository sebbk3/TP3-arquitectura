...
module PIPELINE#(
        ...
        parameter NB_MEM_WIDTH      = 8, // Todas las memorias, excepto el banco de registros tienen ancho de 8
        parameter NB_SEL            = 2
    )
    (
        input                       i_clock,
        ...
        input                       i_MEM_debug_unit_flag,          // Flag de escritura y lectura provenientes de DEBUG UNIT
    ...
    (
        ...
        .i_halt(EX_halt),
        .i_mem_fwd_data(MEM_alu_result),        // forwarded desde MEM
        .i_wb_fwd_data(WB_selected_data),       // forwarded desde WB
    ...
    (
        ...
        .o_forwarding_a(forwarding_a),              // Hacia EX
        .o_forwarding_b(forwarding_b),              // Hacia EX   
        .o_forwarding_mux(forwarding_mux)           // Hacia EX   
    );  
    ...
    (
        ...
        .i_MEM_halt(MEM_halt),
        .i_WB_halt(WB_halt),
        .i_branch_taken(MEM_branch_zero),           // Desde MEM
  ...
  assign o_bank_register_data       = ID_data_a;           // Hacia DEBUG UNIT
  assign o_mem_data_data            = MEM_read_dm;         // Hacia DEBUG UNIT
  assign o_last_pc                  = IF_last_pc;          // Hacia DEBUG UNIT
