...
module forwarding_unit #(
    ...
    always@(*) begin
        if(i_reset) begin
            ...
            // Si ninguna de las se√±ales de escritura en registros esta° activa, nuevamente, se restablecen las salidas a valores predeterminados.
            ...
            //y tambien
            //la senial de escritura en memoria (i_MEM_write_reg) esta° activa
            //Se establece:
            ...
            // y tambien 
            // la senial de escritura en registro en la etapa WRITE-BACK (i_WB_write_reg) esta° activa
            // Se establece:
            ...
            // y las se√±ales de escritura en memoria y registros.
