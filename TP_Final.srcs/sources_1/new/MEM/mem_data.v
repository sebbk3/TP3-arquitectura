...
module mem_data#(
  parameter MEMORY_WIDTH = 32,              // Ancho de palabra
...
(
  input                 	i_clock,        
  input                 	i_enable,      
  input                 	i_write, 		// Habilita la escritura
  input                 	i_read,  		// Habilita la lectura 
  input  [NB_ADDR-1:0]  	i_read_addr,   	// Direccion de memoria
