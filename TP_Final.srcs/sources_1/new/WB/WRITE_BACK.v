...
module WRITE_BACK#(
    ...
    (   input                   i_reg_write,            // Pasamanos de que SI se escribe en un registro
    ...
    mux2 mux2_11
    (
        .i_SEL(i_last_register_ctrl),           // JAL Y JALR guardan el valor de PC en LAST REGISTER en el banco de registros
        .i_A(mux2_5_data),
        .i_B(i_pc),
