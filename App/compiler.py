...
def compilar(file: str):
    ...
    for linea in programa:
        ...
        # Escribir la instrucción completa de 32 bits en una línea
        compiled.write(asm + "\n")
        assembled.append(asm)
        line_count += 1

    # Rellenar con ceros hasta llegar a 64 instrucciones
    for line in range(line_count, 64, 1):
        zeros_32_bits = "00000000000000000000000000000000"
        compiled.write(zeros_32_bits + "\n")
        assembled.append(zeros_32_bits)
